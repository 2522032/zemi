...
function generate_invite_code7(): string {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($groupName === '') {
        ...
        try {
            do {
                $invite = generate_invite_code7();
                $chk = $pdo->prepare("SELECT 1 FROM groups WHERE invite_code = :c");
                $chk->execute([':c' => $invite]);
...
<body>
  ...
  <main class="wrap">
    <div class="grid">
      ...
      <section class="hero">
        <h1>グループを作成</h1>
        <p>家族・同居人など、同じ生活圏の人と情報を共有する単位を作ります。</p>
        <div class="chips">
          <span class="chip"><i class="bi bi-people me-1"></i> メンバーを招待</span>
          <span class="chip"><i class="bi bi-chat-dots me-1"></i> 状態を共有</span>
          <span class="chip"><i class="bi bi-shield-lock me-1"></i> 安全に管理</span>
        </div>
      </section>
      ...
      <section class="card-glass">
        <div class="card-body">
          ...
          <p class="subtitle">家の名前や分かりやすい名称を入力してください。</p>
          ...
          <form method="post" class="mt-4">
            <div class="mb-3">
              ...
              <div class="hint">家の名前や分かりやすい名称がおすすめです。</div>
            </div>

            <div class="d-grid gap-2 mt-4">
              <button type="submit" class="btn btn-primary btn-lg">
                <i class="bi bi-plus-circle me-1"></i> グループを作成する
              </button>
