...
<head>
  ...
  <style>
    ...
    .title{ font-weight:800; margin:0; font-size:1.25rem; }
...
<body>
  ...
  <main class="wrap">
    <div class="auth-grid">
      ...
      <section class="hero">
        <h1>はじめまして 👋</h1>
        <p>SafeHomeアカウントを作成して、家族（グループ）の共有を始めましょう。</p>

        <div class="chips">
          <span class="chip"><i class="bi bi-person-check me-1"></i> すぐに利用開始</span>
          <span class="chip"><i class="bi bi-lock me-1"></i> パスワードはハッシュ化</span>
          <span class="chip"><i class="bi bi-people me-1"></i> グループに参加/作成</span>
        </div>
      </section>
        ...
        <div class="card-body">
          ...
          <form method="post" class="mt-4">
            <div class="mb-3">
              ...
              <div class="hint">例：shunya_marumo（英数字・短め推奨）</div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="hint">8文字以上など、ルールがあるならここに書ける</div>
            </div>

            <div class="d-grid gap-2 mt-4">
              <button type="submit" class="btn btn-primary btn-lg">
                <i class="bi bi-person-plus me-1"></i> 登録して始める
              </button>

              <a class="btn btn-ghost btn-lg" href="login.php">
                <i class="bi bi-box-arrow-in-right me-1"></i> すでにアカウントがある
              </a>

              <div class="text-center mt-2">
                <a class="link-soft" href="login.php">ログイン画面へ →</a>
              </div>
            </div>
          </form>
